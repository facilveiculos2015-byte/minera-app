...
function garantirBrandLogo() {
    ...
    const src = root + 'logo-escavadeira.png?v=20260923ak';
    ...
    function showBrowserNotif(title, body) {
        try {
            ...
            if (Notification.permission === 'granted') {
                new Notification(title, { body: body || '', icon: (typeof APP_ROOT === 'string' ? APP_ROOT : '') + 'logo-escavadeira.png?v=20260923ak' });
            }
        } catch (e) { /* ignore */ }
    }
