...
function htmlCardFamilia(perfil) {
    ...
    return (
        ...
        '<img class="familia-og-logo" src="' + suporteEsc(ogImg) + '?v=20260923n" alt="" width="72" height="72" loading="lazy">' +
...
function mostrarSharePosCadastro(perfil) {
    ...
    host.innerHTML =
        ...
        '<img class="familia-og-logo" src="' + suporteEsc((_shareOgImageUrl || SHARE_OG_IMAGE_DEFAULT)) + '?v=20260923n" alt="" width="72" height="72">' +
